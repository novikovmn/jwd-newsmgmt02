...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
	...
	<%-- messages --%>
	<fmt:message bundle="${locale}" key="baseLayoutPage.title" var="baseLayoutPage_title" />
	<fmt:message bundle="${locale}" key="baseLayoutPage.menu.greeting" var="baseLayoutPage_menu_greeting" />
	<%-- ------------------------------------ --%>	
...
<title>${baseLayoutPage_title}</title>
